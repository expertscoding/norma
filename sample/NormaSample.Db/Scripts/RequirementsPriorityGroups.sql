...
USING ( VALUES 
	...
	((Select Id from norma.Requirements where Name='HasPermission'), (Select Id from norma.PriorityGroups where Name='Priority Group 2')),
	((Select Id from norma.Requirements where Name='HeadQuarters'), (Select Id from norma.PriorityGroups where Name='Priority Group 2'))
)
